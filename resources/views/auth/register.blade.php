        ...
        <div class="mt-4">
            <form action="" method="POST">
                ...
                <div class="flex flex-col space-y-4">
                    <input name="full_name" id="full_name" class="border-2 border-black p-2 rounded-lg" placeholder="Full Name"/>

                    <div class="flex flex-col">
                        <input name="username" id="username" class="border-2 border-black p-2 rounded-lg" placeholder="Username"/>
